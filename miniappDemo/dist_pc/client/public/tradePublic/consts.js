 ...
 *
 */
var TRADE_LIST_BATCH_ACTIONS = exports.TRADE_LIST_BATCH_ACTIONS = {
  MEMO: {
    name: '批量备注',
    key: 'MEMO',
    pid: 742
...
var BATCH_PRINT_BATCH_ACTION = exports.BATCH_PRINT_BATCH_ACTION = {
  PRINT_LOGISTICS: {
    name: '批量打印快递单',
    key: 'PRINT_LOGISTICS',
    pid: 847
...
var WHAT_I_NEED = exports.WHAT_I_NEED = {
  WAIT_BUYER_PAY: {
    key: 'WAIT_BUYER_PAY',
    name: '待付款',
...
var statusNameMap = exports.statusNameMap = {
  WAIT_BUYER_PAY: {
    key: 'WAIT_BUYER_PAY',
    name: '待付款',
    labelClassName: 'label-wait',
...
var STATUS_IS_SENDED = exports.STATUS_IS_SENDED = {
  'WAIT_BUYER_PAY': 0,
  'TRADE_FINISHED': 1,
  'WAIT_BUYER_CONFIRM_GOODS': 1,
  'WAIT_SELLER_SEND_GOODS': 0
};
var TRADE_SORT_BY = exports.TRADE_SORT_BY = {
...
var REFUND_TABS = exports.REFUND_TABS = {
  ALL: {
    key: 'ALL',
    name: '所有退款'
  },
...
var TRADE_TABS = exports.TRADE_TABS = {
  THREE_MONTH: {
    key: 'THREE_MONTH',
    name: '近三个月',
    query_status: '',
    batchActions: [TRADE_LIST_BATCH_ACTIONS.MEMO],
    sortType: [TRADE_SORT_BY.create_time_desc.key, TRADE_SORT_BY.create_time_asc.key],
  ...
  WAIT_BUYER_PAY: {
    ...
    batchActions: [TRADE_LIST_BATCH_ACTIONS.CLOSE, TRADE_LIST_BATCH_ACTIONS.FREE_POST,
  ...
  WAIT_SELLER_SEND_GOODS: {
    ...
    batchActions: [TRADE_LIST_BATCH_ACTIONS.SEND, TRADE_LIST_BATCH_ACTIONS.PRINT_DELIVERY, TRADE_LIST_BATCH_ACTIONS.PRINT_ELECFACE, TRADE_LIST_BATCH_ACTIONS.PRINT_LOGISTICS, TRADE_LIST_BATCH_ACTIONS.MEMO],
    batchPrintBatchAction: [BATCH_PRINT_BATCH_ACTION.PRINT_LOGISTICS, BATCH_PRINT_BATCH_ACTION.PRINT_ELECFACE, BATCH_PRINT_BATCH_ACTION.PRINT_DELIVERY, BATCH_PRINT_BATCH_ACTION.SEND],
    sortType: [TRADE_SORT_BY.create_time_desc.key, TRADE_SORT_BY.create_time_asc.key, TRADE_SORT_BY.pay_time_desc.key, TRADE_SORT_BY.pay_time_asc.key],
    donotSearch: {
      timeFilterBy: {
        key: 'timeFilterBy',
        value: ['consign_time']
  ...
  WAIT_BUYER_CONFIRM_GOODS: {
    ...
    batchActions: [TRADE_LIST_BATCH_ACTIONS.PRINT_DELIVERY, TRADE_LIST_BATCH_ACTIONS.PRINT_ELECFACE, TRADE_LIST_BATCH_ACTIONS.PRINT_LOGISTICS, TRADE_LIST_BATCH_ACTIONS.MEMO],
    batchPrintBatchAction: [BATCH_PRINT_BATCH_ACTION.PRINT_LOGISTICS, BATCH_PRINT_BATCH_ACTION.PRINT_ELECFACE, BATCH_PRINT_BATCH_ACTION.PRINT_DELIVERY],
    sortType: [TRADE_SORT_BY.create_time_desc.key, TRADE_SORT_BY.create_time_asc.key, TRADE_SORT_BY.pay_time_desc.key, TRADE_SORT_BY.pay_time_asc.key, TRADE_SORT_BY.consign_time_desc.key, TRADE_SORT_BY.consign_time_asc.key],
    donotSearch: {
      tag: {
        key: 'tag',
  ...
  NEED_RATE: {
    key: 'NEED_RATE',
    name: '待评价',
    batchActions: [TRADE_LIST_BATCH_ACTIONS.RATE, TRADE_LIST_BATCH_ACTIONS.MEMO],
    sortType: [TRADE_SORT_BY.create_time_desc.key, TRADE_SORT_BY.create_time_asc.key, TRADE_SORT_BY.pay_time_desc.key, TRADE_SORT_BY.pay_time_asc.key, TRADE_SORT_BY.consign_time_desc.key, TRADE_SORT_BY.consign_time_asc.key],
    donotSearch: {
      tag: {
        key: 'tag',
...
var promiseService = exports.promiseService = [{
  label: '全部',
  value: 'all'
}, {
  label: '当天发货',
...
var FOOT_PAGE_SIZE = exports.FOOT_PAGE_SIZE = {
  tradeManagement: [20, 40, 80, 100],
  batchPrint: [20, 40, 80, 100, 200]
};

// 地址筛选
var addrState = exports.addrState = ['辽宁省', '湖北省', '山西省', '福建省', '青海省', '江西省', '河南省', '宁夏回族自治区', '澳门特别行政区', '浙江省', '新疆维吾尔自治区', '吉林省', '安徽省', '内蒙古自治区', '台湾', '海南省', '香港特别行政区', '云南省', '贵州省', '江苏省', '西藏自治区', '北京', '四川省', '黑龙江省', '广西壮族自治区', '陕西省', '天津', '广东省', '重庆', '河北省', '湖南省', '甘肃省', '山东省', '海外', '上海'];
var addrSourceChildren = [];
var _iteratorNormalCompletion = true;
var _didIteratorError = false;
var _iteratorError = undefined;

try {
  for (var _iterator = addrState[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
var addrSource = exports.addrSource = [{
  label: '',
  children: [{
    label: '所有省份',
    value: 'all'
...
var ADDR_SOURCE_CHILDREN = JSON.parse(JSON.stringify(addrSourceChildren));
var ADDR_SOURCES = exports.ADDR_SOURCES = addrSource[0].children.filter(function (item) {
  return item.value != 'all';
}).concat(ADDR_SOURCE_CHILDREN);

var SEARCH_TYPE = exports.SEARCH_TYPE = {
...
var SEARCH_INP = exports.SEARCH_INP = {
  status: {
    key: 'status',
...
var SEARCH_DATE_TYPE = exports.SEARCH_DATE_TYPE = {
  today: {
    key: 'today',
    value: '今日',
    startTimediff: 0,
...
var TRADE_STATUS_TO_TAB_STATUS_MAP = exports.TRADE_STATUS_TO_TAB_STATUS_MAP = {
...
var CLOSE_REASON_MAP = exports.CLOSE_REASON_MAP = {
  TRADE_CLOSED: '交易自动关闭',
  TRADE_CLOSED_BY_TAOBAO: '卖家或买家主动关闭交易'
};

var RATE_API_QUERY = exports.RATE_API_QUERY = {
  'buyer': { // 买家给卖家的评价
...
var ORDER_DETECTION_SETTING_OPTIONS = exports.ORDER_DETECTION_SETTING_OPTIONS = [{
  key: 'dangerTrade',
...
var CLOSE_TRADE_REASONS = exports.CLOSE_TRADE_REASONS = ['未及时付款', '买家不想买了', '买家信息填写错误，重新拍', '恶意买家/同行捣乱', '缺货', '买家拍错了', '同城见面交易'];
var TRADE_ORDER_TYPE = exports.TRADE_ORDER_TYPE = [{
  key: 'all',
  name: '所有订单'
}, {
  key: '0',
...
var TRADE_BILL_TYPE = exports.TRADE_BILL_TYPE = [{
  key: '所有类型',
  name: '所有类型'
}, {
  key: 'Expface',
...
var STATUS_NAME_MAP = exports.STATUS_NAME_MAP = {
  WAIT_BUYER_PAY: '待付款',
