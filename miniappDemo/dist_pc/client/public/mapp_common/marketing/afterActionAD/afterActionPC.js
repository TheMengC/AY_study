...
var AfterActionADpc = (_temp2 = _class = function (_BaseComponent) {
  _inherits(AfterActionADpc, _BaseComponent);

  function AfterActionADpc() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, AfterActionADpc);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AfterActionADpc.__proto__ || Object.getPrototypeOf(AfterActionADpc)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp3", "anonymousState__temp4", "anonymousState__temp5", "flag_image", "isModal", "symbol", "anonymousState__temp", "anonymousState__temp2", "canClose", "close_icon", "later_float", "title", "caption", "later_text", "state", "pid", "ad", "close"], _this.goLink = function (url) {
      _this.closeAD();
      (0, _biz.goClick)({
  ...
  _createClass(AfterActionADpc, [{
    key: "_constructor",
    value: function _constructor(props) {
      _get(AfterActionADpc.prototype.__proto__ || Object.getPrototypeOf(AfterActionADpc.prototype), "_constructor", this).call(this, props);
  ...
  return AfterActionADpc;
}(_index.Component), _class.$$events = ["anonymousFunc0", "closeAD", "goToBall", "backToModal"], _class.$$componentPath = "public/mapp_common/marketing/afterActionAD/afterActionPC", _temp2);
...
exports.default = AfterActionADpc;

Component(require('../../../../npm/_tarojs/taro-alipay/index.js').default.createComponent(AfterActionADpc));