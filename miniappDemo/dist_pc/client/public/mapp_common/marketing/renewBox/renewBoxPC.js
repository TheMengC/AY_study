...
var RenewBoxPC = (_temp2 = _class = function (_BaseComponent) {
  ...
  function RenewBoxPC() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RenewBoxPC.__proto__ || Object.getPrototypeOf(RenewBoxPC)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__27", "anonymousState__temp", "closeNow", "midModalState", "ENV", "box_content", "box_span", "pid", "ad", "close"], _this.dealBoxContent = function (adInfo) {
