...
var payResultContent = {
  payDefault: {
    header: '温馨提示',
    content: ['请您在新开的页面上完成付款，付款完成前请不要关闭此窗口。完成付款后请根据您的情况点击下面的按钮。'],
    rightBtn: '付款遇到问题',
    rightFunc: 'problemClick',
    leftFunc: 'afterPay',
    leftBtn: '已完成付款',
    talkContent: "\u6211\u60F3payName" + _env.ENV.appName + "\uFF0C\u4F46\u662FpayName\u5931\u8D25\u4E86\uFF0C\u6211\u8BE5\u600E\u4E48\u529E\uFF1F"
  },
  renewDefault: {
    header: '温馨提示',
...
var PayResultPC = (_temp2 = _class = function (_BaseComponent) {
  _inherits(PayResultPC, _BaseComponent);

  function PayResultPC() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, PayResultPC);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PayResultPC.__proto__ || Object.getPrototypeOf(PayResultPC)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "_$content", "_$btns", "_$btnText", "_$successType", "_$anonymousState__temp", "_$anonymousState__temp2", "loopArray17", "$compid__31", "$compid__32", "contentType", "pid", "payResultInfo"], _this.onClose = function () {
  ...
  _createClass(PayResultPC, [{
    key: "_constructor",
    value: function _constructor(props) {
      _get(PayResultPC.prototype.__proto__ || Object.getPrototypeOf(PayResultPC.prototype), "_constructor", this).call(this, props);
    ...
    */
    ...
    value: function _createData() {
      ...
      var _genCompid = (0, _index.genCompid)(__prefix + "$compid__31"),
          _genCompid2 = _slicedToArray(_genCompid, 2),
          $prevCompid__31 = _genCompid2[0],
          $compid__31 = _genCompid2[1];

      var _genCompid3 = (0, _index.genCompid)(__prefix + "$compid__32"),
      ...
      if (anonymousState__temp) {
        ...
        propsManager.set({
          ...
          "className": "pc-pay-result-wrapper"
  ...
  return PayResultPC;
}(_index.Component), _class.$$events = ["onClose", "anonymousFunc0"], _class.$$componentPath = "public/mapp_common/marketing/payResult/payResultPC", _temp2);
exports.default = PayResultPC;

Component(require('../../../../npm/_tarojs/taro-alipay/index.js').default.createComponent(PayResultPC));